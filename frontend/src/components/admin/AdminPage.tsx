...
function AdminPage() {
  ...
  const renderMainContent = () => {
    switch (activeTab) {
      ...
      case "users":
        return (
          <div className="bg-white p-4 sm:p-6 rounded-xl border border-gray-200 shadow-sm overflow-x-auto">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4">Gestion des utilisateurs</h2>
            <UserList />
          </div>
        );
      ...
      case "categories":
        return (
          <div className="bg-white p-4 sm:p-6 rounded-xl border border-gray-200 shadow-sm overflow-x-auto">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4">Gestion des catégories</h2>
            <CategoryList />
          </div>
        );
      ...
      case "analytics":
        return (
          <div className="bg-white p-4 sm:p-6 rounded-xl border border-gray-200 shadow-sm">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4">Statistiques & Analyses</h2>
      ...
      case "orders":
        return (
          <div className="bg-white p-4 sm:p-6 rounded-xl border border-gray-200 shadow-sm overflow-x-auto">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4">Commandes récentes</h2>
      ...
      case "returns":
        return (
          <div className="bg-white p-4 sm:p-6 rounded-xl border border-gray-200 shadow-sm overflow-x-auto">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4">Demandes de Retour Produit</h2>
      ...
      case "products":
        return (
          <div className="bg-white p-4 sm:p-6 rounded-xl border border-gray-200 shadow-sm overflow-x-auto">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4">Catalogue Produits</h2>
            <ProductList />
          </div>
        );
  ...
  return (
    <div className="bg-gray-100 min-h-screen relative">
      ...
      {/* Sidebar Responsive */}
      <aside 
        className={`fixed inset-y-0 left-0 w-64 bg-gray-900 shadow-xl z-50 flex flex-col justify-between transform transition-transform duration-300 ease-in-out ${
      ...
      >
        <div className="flex flex-col h-full overflow-y-auto">
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center justify-between px-4 py-3 font-semibold rounded-lg transition-colors group text-sm ${
                    isActive
          ...
          {/* Bottom Section */}
          <div className="p-4 space-y-3 mt-auto border-t border-gray-800">
            <Link
              to="/"
      ...
      <div className="lg:ml-64 flex flex-col min-h-screen">
            ...
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="hidden sm:block text-xs sm:text-sm mt-0.5 text-gray-500">
              ...
              <div className="flex items-center">
                <button
                  ...
                  className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-red-50 text-red-600 hover:bg-red-600 hover:text-white rounded-lg font-semibold text-xs sm:text-sm transition-colors duration-200 border border-red-100"
                >
        ...
        {/* Main Content */}
        <main className="p-4 sm:p-6 flex-1">{renderMainContent()}</main>
      </div>
    </div>
  );
}

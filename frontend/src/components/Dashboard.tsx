  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white text-slate-900">
                  ...
                  {banners.map((slide) => (
                    <div key={slide.id} className="relative w-full h-full flex-shrink-0">
                      ...
                      <div className="relative z-10 h-full flex flex-col justify-center px-6 sm:px-12 max-w-2xl text-white">
                        ...
                        {slide.subtitle && (
                          <p className="text-xs sm:text-sm text-gray-200 mt-2 font-normal">
                            {slide.subtitle}
                          </p>
                        )}
                        <div className="mt-5">
        ...
        {/* ================= SECTION CATÉGORIES DYNAMIQUES (BDD) ================= */}
        <section className="px-4 py-12 max-w-7xl mx-auto" id="categories">
            ...
            {!loadingCategories && categories.length > 0 && (
              ...
              >
                ...
                <div className="flex items-center justify-center h-24 w-full mb-2 overflow-hidden rounded-lg bg-indigo-100/50 text-indigo-600 font-bold text-xl">
                  <img src="/src/assets/all-cat.jpeg" alt="All Categories" />
                </div>
